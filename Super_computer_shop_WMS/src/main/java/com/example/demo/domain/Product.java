...
public class Product implements Serializable {
    ...
    /*Method for purchasing a product using our "buy now" button
    Checking to see if we have some inventory and if we do, we will decrease
    the inventory by 1. Then we return true or false to represent whether
