...
class PartTest {
    ...
    /*two unit test for setting our minInv and maxInv variables
    to make sure that they are properly take a given int and
    returns the correct value*/
    @Test
    void testMinInv(){
        int mini = 2;
        partIn.setMinInv(mini);
        assertEquals(mini, partIn.getMinInv());
        partOut.setMinInv(mini);
        assertEquals(mini, partOut.getMinInv());
    }

    @Test
    void testMaxInv(){
        int maxi = 199;
        partIn.setMaxInv(maxi);
        assertEquals(maxi, partIn.getMaxInv());
        partOut.setMaxInv(maxi);
        assertEquals(maxi, partOut.getMaxInv());
    }
}